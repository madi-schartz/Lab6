...
# Minimal node size seem to have a similar relationship in relation to mae and rmse where as they increase the metrics decrease but with the metric rsq they all increase together. The trees are a bit more complicated but follow a similar relationship pattern as minimal node size does. 
